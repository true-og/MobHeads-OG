...
object Heads {
    private val headIndex = mapOf(
        EntityType.ALLAY to URL("http://textures.minecraft.net/texture/cc0389177dbaa92f0d5ffdf848862c7f9b36df222fbfd737e2639dc3059e0cf3"),
//        EntityType.AXOLOTL to URL("http://textures.minecraft.net/texture/667e15eab73064b6680d1db98ba445ed0914ba35a799997c0da2b03ffc3a8826"),
        EntityType.BAT to URL("http://textures.minecraft.net/texture/8eb81c40b5b63f3d830340f8fcc4aab538d4e544e95eec9d70d61f786f6b6974"),
        EntityType.BEE to URL("http://textures.minecraft.net/texture/59ac16f296b461d05ea0785d477033e527358b4f30c266aa02f020157ffca736"),
        EntityType.BLAZE to URL("http://textures.minecraft.net/texture/dee23dc7a10c6a87ef937454c0e94ed42c23aa641a91ed8470a3042d05c52c52"),
//        EntityType.CAT to URL("http://textures.minecraft.net/texture/de28d30db3f8c3fe50ca4f26f3075e36f003ae8028135a8cd692f24c9a98ae1b"),
        EntityType.CAVE_SPIDER to URL("http://textures.minecraft.net/texture/a6a1c2599fc91203a65a03d479c8dc87f662deac3663c16c5e04d625b3978a25"),
        EntityType.CHICKEN to URL("http://textures.minecraft.net/texture/42af6e5847eea099e1b0ab8c20a9e5f3c7190158bda54e28133d9b271ec0cb4b"),
        EntityType.COD to URL("http://textures.minecraft.net/texture/f246e19b32cf784549447e07b96072e1f656d78e93ccca5637485e6749734652"),
        EntityType.COW to URL("http://textures.minecraft.net/texture/63d621100fea5883922e78bb448056448c983e3f97841948a2da747d6b08b8ab"),
        EntityType.CREEPER to URL("http://textures.minecraft.net/texture/3511e4a3d5add6a54499abad10d799d06ce45cba9e520afd2008608a6288b7e7"), // Charged Creeper
        EntityType.DOLPHIN to URL("http://textures.minecraft.net/texture/8e9688b950d880b55b7aa2cfcd76e5a0fa94aac6d16f78e833f7443ea29fed3"),
        EntityType.DONKEY to URL("http://textures.minecraft.net/texture/4e25ee9273ad579d44bf406f6f6295586481ea198fd572076cd0c5882da7e6cc"),
        EntityType.DROWNED to URL("http://textures.minecraft.net/texture/c3f7ccf61dbc3f9fe9a6333cde0c0e14399eb2eea71d34cf223b3ace22051"),
        EntityType.ELDER_GUARDIAN to URL("http://textures.minecraft.net/texture/4a2d64f4a00e9c85f67262edcacb84523581ae0f37bdab22dd704524f62e169f"),
        EntityType.ENDERMAN to URL("http://textures.minecraft.net/texture/8977a94f02498cad0cfdb65ca7cb72e23111a914d8c670acccc7a65b347d7776"),
...
//        EntityType.FOX to URL("http://textures.minecraft.net/texture/d7e0043111bc57090856259155571c7906e707046df041b8b572704c451fcd82"),
        ...
        EntityType.GUARDIAN to URL("http://textures.minecraft.net/texture/e2ba34416670454b1a20496f80b9398529f49003fc613eb930248ea9b5d1a391"),
        EntityType.HOGLIN to URL("http://textures.minecraft.net/texture/bc4a7f57fc03b13aa2f9d83cdd4822b936793096daf51e78025bbd241ed6f68d"),
//        EntityType.HORSE to URL("http://textures.minecraft.net/texture/c7bc61609730f2cb010268fab0821bd47352699750a150599f21c3fc4e92591a"),
        EntityType.HUSK to URL("http://textures.minecraft.net/texture/7338318bc91a36cd5ab6aa885c9a4ee2bdacdaa5c66b2a99dfb0a560983f2480"),
        EntityType.ILLUSIONER to URL("http://textures.minecraft.net/texture/d382701c67d6c54c907558891dc176225112518771e061c5d8bd918479e6bdd8"),
        EntityType.IRON_GOLEM to URL("http://textures.minecraft.net/texture/fe7c0719fabe116dce605199bcadc69a538860864ef15706983ff662822d9fe3"),
//        EntityType.LLAMA to URL("http://textures.minecraft.net/texture/4d67fd4bff293269cb908974dca83c33485e435ed5a8e1dbd6521c61687140"),
        EntityType.MAGMA_CUBE to URL("http://textures.minecraft.net/texture/b81718d4984847a4ad3ec081a4ebffd183743239aecab60322138a72609812c3"),
//        EntityType.MUSHROOM_COW to URL("http://textures.minecraft.net/texture/da80606e82c642f141587733e3180ae57f646442c9fffd4e5997457e34311a29"),
        EntityType.MULE to URL("http://textures.minecraft.net/texture/41c224a1031be434d25ae1885bf4ff400c9894c69bfef56a49354c5625c0c09c"),
        EntityType.OCELOT to URL("http://textures.minecraft.net/texture/9175cc43ea8ae20168a1f170810b4da4d9b4ebd3c9976e9fc22e9f995c3cbc3c"),
//        EntityType.PANDA to URL("http://textures.minecraft.net/texture/e546e436d166b17f0521bd8538ea13cd6ee3b5df102eb32e3e425cb285d44063"),
//        EntityType.PARROT to URL("http://textures.minecraft.net/texture/40a3d47f54e71a58bf8f57c5253fb2d213f4f55bb7934a19104bfb94edc76eaa"),
        EntityType.PHANTOM to URL("http://textures.minecraft.net/texture/7e95153ec23284b283f00d19d29756f244313a061b70ac03b97d236ee57bd982"),
        EntityType.PIG to URL("http://textures.minecraft.net/texture/41ee7681adf00067f04bf42611c97641075a44ae2b1c0381d5ac6b3246211bfe"),
        EntityType.PIGLIN to URL("http://textures.minecraft.net/texture/81afd85391182a9f9de4fce29eaf02514cc2e04481577da5edeb58b17e757135"),
        EntityType.PIGLIN_BRUTE to URL("http://textures.minecraft.net/texture/6488799c83ecb29452ceba89c3c0099219274ce5b2bfb8ad0b3ea4c65fac4630"),
        EntityType.PILLAGER to URL("http://textures.minecraft.net/texture/c225f0b49c5295048a409c9c601cca79aa8eb52aff5e2033ebb865f4367ef43e"),
        EntityType.POLAR_BEAR to URL("http://textures.minecraft.net/texture/cd8702911e616c0d32fbe778d195f21ecce9025bcbd09151e3d97af3192aa7ec"),
        EntityType.PUFFERFISH to URL("http://textures.minecraft.net/texture/e2733d5da59c82eaf310b382aff40bd513c44354dbbabfe14b066a556810a7f9"),
//        EntityType.RABBIT to URL("http://textures.minecraft.net/texture/51a57c3d0a9b10e13f66df74200cb8a6d484c672226812d74e25f6c027410616"),
        EntityType.RAVAGER to URL("http://textures.minecraft.net/texture/eb4db2986140e251e32e70ed08c8a081720313ce257632be1ef94a0737394db"),
        EntityType.SALMON to URL("http://textures.minecraft.net/texture/791d9e69b795da4eaacfcf7350dfe8ae367fed833556706e040339dd7fe0240a"),
//        EntityType.SHEEP to URL("http://textures.minecraft.net/texture/7ca38ccf417e99ca9d47eeb15a8a30edb1507aa52b678c220c717c474aa6fe3e"),
        EntityType.SHULKER to URL("http://textures.minecraft.net/texture/fb9e6af6b819f3d90e67ce2e7059fbef31da2aa953d35e3454f1021fa912efde"),
        EntityType.SILVERFISH to URL("http://textures.minecraft.net/texture/f25e9fae371664de1a800c84d025124abb8f15111807c8bc1ab9126aacbd4f95"),
        EntityType.SKELETON_HORSE to URL("http://textures.minecraft.net/texture/6e226705bd2a9e7bb8d6b0f4daa969b9e12d4ae5c66da693bb5f4a4a1e6aa296"),
        EntityType.SLIME to URL("http://textures.minecraft.net/texture/c06424ec7a196b15f9ad5733a36a6d1f2e6a0d42ffce1e1508f90f312ac4caed"),
        EntityType.SNOWMAN to URL("http://textures.minecraft.net/texture/caa3e17ef1b29a4b87fa43dee1db12c41fd39aa387fa13af2a079b5b378fde8b"),
        EntityType.SPIDER to URL("http://textures.minecraft.net/texture/de28e6629b6ed1da94d4a818761612c36fb3a6813c4b63fb9fea5076415f3f0c"),
        EntityType.SQUID to URL("http://textures.minecraft.net/texture/8351b7d9a4f36cfe31fd59d8c900e419a135144105e7a981caa5a168dcff325b"),
        EntityType.STRAY to URL("http://textures.minecraft.net/texture/592b5597085e35db53d9bda008cae72b2f00cd7d4cd8dc69ff174a55b689e6e"),
        EntityType.STRIDER to URL("http://textures.minecraft.net/texture/9c40fad1c11de9e6422b405426e9b97907f35bce345e3758604d3e7be7df884"),
        EntityType.TADPOLE to URL("http://textures.minecraft.net/texture/3daf1653b5f59b5ec5a3f79609cb4233579fef07e693b61749e0900149edf563"),
//        EntityType.TRADER_LLAMA to URL("http://textures.minecraft.net/texture/e89a2eb17705fe7154ab041e5c76a08d41546a31ba20ea3060e3ec8edc10412c"),
        EntityType.TROPICAL_FISH to URL("http://textures.minecraft.net/texture/34a0c84dc3c090df7bafc4367a9fc6c8520da2f73efffb80e934d1189eadac41"),
        EntityType.TURTLE to URL("http://textures.minecraft.net/texture/304931200ad460b650a190e8d41227c3999fbeb933b51ca49fd9e5920d1f8e7d"),
        EntityType.VEX to URL("http://textures.minecraft.net/texture/b9538f2830c4dea6996ed744785504e32e0e20d8663edab6b0222f2c022077bd"),
//        EntityType.VILLAGER to URL("http://textures.minecraft.net/texture/1ef627f566ac0a7828bad93e9e4b9643d99a928a13d5f977bf441e40db1336bf"),
        EntityType.VINDICATOR to URL("http://textures.minecraft.net/texture/2dabafde27ee12b09865047aff6f183fdb64e04dae1c00ccbde04ad93dcc6c95"),
        EntityType.WANDERING_TRADER to URL("http://textures.minecraft.net/texture/5f1379a82290d7abe1efaabbc70710ff2ec02dd34ade386bc00c930c461cf932"),
        EntityType.WARDEN to URL("http://textures.minecraft.net/texture/b2f3879b737127485eb35ddee748d06cf914b193d97753ae34e92230842831fb"),
        EntityType.WITCH to URL("http://textures.minecraft.net/texture/a520f12c63c7912186c4be4e30c33c5acaec0db0b6abd836d517d74a62275d4b"),
        EntityType.WITHER to URL("http://textures.minecraft.net/texture/eda10828f63b7ecdefd767b3245fbdaa13c3ec0c6b13774f1ee8d307c034c383"),
        EntityType.WOLF to URL("http://textures.minecraft.net/texture/b6439a43e5687008815a2dd1ff4a134c12221b782336678b979ad13dce39665e"),
        EntityType.ZOGLIN to URL("http://textures.minecraft.net/texture/2e3493a956bfd7588ed1a8ea858759667659d58100cbecd6d96ccc0ca9b36923"),
        EntityType.ZOMBIE_HORSE to URL("http://textures.minecraft.net/texture/6618ffbe1cfa2058fe80a065f70c128c225a1e0bc9deaf8b38b0395443f40909"),
//        EntityType.ZOMBIE_VILLAGER to URL("http://textures.minecraft.net/texture/c8679e034767d518660d9416dc5eaf319d697682ac40c886e3c2bc8dfa1de1d"),
        EntityType.ZOMBIFIED_PIGLIN to URL("http://textures.minecraft.net/texture/2df03128b002a70708d6825ed6cf54ddf694b3766d78d5649030b1cb8b34c6fa")
    )

    private val mobsWithVariants = arrayOf(
        EntityType.AXOLOTL,
        EntityType.CAT,
        EntityType.HORSE,
    ...
    private val axolotlHeadIndex = mapOf(
        Axolotl.Variant.BLUE to URL("http://textures.minecraft.net/texture/357b32c2933bebcd6502cbf406f7df996c8e46e7c6cbfefc5dcdc2fbf5bb54bb"), // Amy_Lan
        Axolotl.Variant.CYAN to URL("http://textures.minecraft.net/texture/1e8c70e6a56161ecdc6b75674070fb308714a2b2b70e1e6d76bc920ce6ce7de6"), // Amy_Lan
        Axolotl.Variant.GOLD to URL("http://textures.minecraft.net/texture/405bea436985d1b759979c45f56b016486da10943dbf9480d38ea72141f10a81"), // aBANANA159
        Axolotl.Variant.LUCY to URL("http://textures.minecraft.net/texture/7b910fbc216f724d29655155b2a3858a80f234a0cfed609e22fc670683ab777a"), // RunnerLord
        Axolotl.Variant.WILD to URL("http://textures.minecraft.net/texture/4d7efe02012cf31ae2708e7d7df079726575c7ee8504328175fe544708187dce") // ML_Monster
    )

    private val catHeadIndex = mapOf(
        Cat.Type.TABBY to URL("http://textures.minecraft.net/texture/de28d30db3f8c3fe50ca4f26f3075e36f003ae8028135a8cd692f24c9a98ae1b"), // PandaClod
        Cat.Type.BLACK to URL("http://textures.minecraft.net/texture/4fd10c8e75f67398c47587d25fc146f311c053cc5d0aeab8790bce36ee88f5f8"), // PandaClod
        Cat.Type.RED to URL("http://textures.minecraft.net/texture/2113dbd3c6a078a17b4edb78ce07d836c38dace5027d4b0a83fd60e7ca7a0fcb"), // PandaClod
        Cat.Type.SIAMESE to URL("http://textures.minecraft.net/texture/d5b3f8ca4b3a555ccb3d194449808b4c9d783327197800d4d65974cc685af2ea"), // PandaClod
        Cat.Type.BRITISH_SHORTHAIR to URL("http://textures.minecraft.net/texture/5389e0d5d3e81f84b570e2978244b3a73e5a22bcdb6874b44ef5d0f66ca24eec"), // PandaClod
        Cat.Type.CALICO to URL("http://textures.minecraft.net/texture/e0eeaa869f53fa989198f5595520aec9395509aba993596a86654b3a0f6ca4a6"), // Soskun
        Cat.Type.PERSIAN to URL("http://textures.minecraft.net/texture/ff40c746260ef91c96b27159795e87191ae7ce3d5f767bf8c74faad9689af25d"), // PandaClod
        Cat.Type.RAGDOLL to URL("http://textures.minecraft.net/texture/dc7a45d25889e3fdf7797cb258e26d4e94f5bc13eef00795dafef2e83e0ab511"), // PandaClod
        Cat.Type.WHITE to URL("http://textures.minecraft.net/texture/21d15ac9558e98b89aca89d3819503f1c5256c2197dd3c34df5aac4d72e7fbed"), // PandaClod
        Cat.Type.JELLIE to URL("http://textures.minecraft.net/texture/a0db41376ca57df10fcb1539e86654eecfd36d3fe75e8176885e93185df280a5"), // PandaClod
        Cat.Type.ALL_BLACK to URL("http://textures.minecraft.net/texture/22c1e81ff03e82a3e71e0cd5fbec607e11361089aa47f290d46c8a2c07460d92") // PandaClod
    )

    private val horseHeadIndex = mapOf(
        Horse.Color.WHITE to URL("http://textures.minecraft.net/texture/60a2db2f1eb93e5978d2dc91a74df43d7b75d9ec0e694fd7f2a652fbd15"),
        Horse.Color.CREAMY to URL("http://textures.minecraft.net/texture/628d1ab4be1e28b7b461fdea46381ac363a7e5c3591c9e5d2683fbe1ec9fcd3"),
        Horse.Color.CHESTNUT to URL("http://textures.minecraft.net/texture/b66b2b32d31539c7383d923bae4faaf65da6715cd526c35d2e4e6825da11fb"),
        Horse.Color.BROWN to URL("http://textures.minecraft.net/texture/bedf73ea12ce6bd90a4ae9a8d15096749cfe918230dc829b2581d223b1a2a8"), // neeeekolaz
        Horse.Color.BLACK to URL("http://textures.minecraft.net/texture/3efb0b9857d7c8d295f6df97b605f40b9d07ebe128a6783d1fa3e1bc6e44117"), // titigillette
        Horse.Color.GRAY to URL("http://textures.minecraft.net/texture/d6676c4d6f0f5ed606a356f3cc5a29d14aafe65721ba1a1a95c5ac4c5e239e5"), // neeeekolaz
        Horse.Color.DARK_BROWN to URL("http://textures.minecraft.net/texture/2661f23fb76624ffbabbda31ca4a38b404fe63ef37d4ba4e4c5441a21e3a6") // neeeekolaz
    )

    private val mooshroomHeadIndex = mapOf(
        MushroomCow.Variant.RED to URL("http://textures.minecraft.net/texture/43e75a01a398a31e2d282bbbfd2b6172d2ae67cd83876948485b85881a15af23"), // DorkOrc
        MushroomCow.Variant.BROWN to URL("http://textures.minecraft.net/texture/1051f5cd554d972050dfc53cecd5d75325489004ad08b3e54572acad96b25363") // DorkOrc
    )

    private val parrotHeadIndex = mapOf(
        Parrot.Variant.RED to URL("http://textures.minecraft.net/texture/a4ba8d66fecb1992e94b8687d6ab4a5320ab7594ac194a2615ed4df818edbc3"),
    ...
    private val rabbitHeadIndex = mapOf(
        Rabbit.Type.BROWN to URL("http://textures.minecraft.net/texture/7d1169b2694a6aba826360992365bcda5a10c89a3aa2b48c438531dd8685c3a7"), // ChimpD
        Rabbit.Type.WHITE to URL("http://textures.minecraft.net/texture/72c58116a147d1a9a26269224a8be184fe8e5f3f3df9b61751369ad87382ec9"), // ChimpD
        Rabbit.Type.BLACK to URL("http://textures.minecraft.net/texture/19a675edb3cba0f3436ae9473cf03592b7a49d38813579084d637e7659999b8e"), // ML_Monster
        Rabbit.Type.BLACK_AND_WHITE to URL("http://textures.minecraft.net/texture/32f39e0a603386ca1ee36236e0b490a1547e6e2a89911674509037fb6f711810"), // ML_Monster
        Rabbit.Type.GOLD to URL("http://textures.minecraft.net/texture/2a6361fea24b111ed78c1fefc295212e8a59b0c88b656062527b17a2d7489c81"), // ML_Monster
        Rabbit.Type.SALT_AND_PEPPER to URL("http://textures.minecraft.net/texture/cc4349fe9902dd76c1361f8d6a1f79bff6f433f3b7b18a47058f0aa16b9053f"), // ML_Monster
        Rabbit.Type.THE_KILLER_BUNNY to URL("http://textures.minecraft.net/texture/ef98337b8242229d95da23090755789778b18bf5d07d61f620cdbdbbd29fa615") // ML_Monster
    )

    private val sheepHeadIndex = mapOf(
        DyeColor.WHITE to URL("http://textures.minecraft.net/texture/292df216ecd27624ac771bacfbfe006e1ed84a79e9270be0f88e9c8791d1ece4"), // ML_Monster
        DyeColor.ORANGE to URL("http://textures.minecraft.net/texture/4271442d8a37db49f02a94c29352694962b5d0bd6bea05f1d93fe19eb4e7060e"), // ML_Monster
        DyeColor.MAGENTA to URL("http://textures.minecraft.net/texture/fe228b04e9b979a10b70b8db6f3fb199deeb581594a5aa4a7febe948db17228b"), // ML_Monster
        DyeColor.LIGHT_BLUE to URL("http://textures.minecraft.net/texture/c8eb0d17479870b3973e8e001b82dcde22efc9d10c90412c6733a0b136564d1f"), // ML_Monster
        DyeColor.YELLOW to URL("http://textures.minecraft.net/texture/12a5354c230e861aac72734a4582d1317026454b807ac353fc3a0bd0d8c422ba"), // ML_Monster
        DyeColor.LIME to URL("http://textures.minecraft.net/texture/1ce4090e1bccf992b36def74a6d7d3972c17db1b75554e2c509271680b8e7974"), // ML_Monster
        DyeColor.PINK to URL("http://textures.minecraft.net/texture/2e7cf1c58dbb7c3255b94c6043fa8f0d776c134f4d98b81ca31410965f47a25a"), // ML_Monster
        DyeColor.GRAY to URL("http://textures.minecraft.net/texture/e6c2a2755b20ddff551a6903f2dc7e61f13ebe39b1d5ca929c87bd8583ec801f"), // ML_Monster
        DyeColor.LIGHT_GRAY to URL("http://textures.minecraft.net/texture/74a59be620ae8b3ee0dd0fa22c80affed4a0f729295cb8c41e78ee783f4633ad"), // ML_Monster
        DyeColor.CYAN to URL("http://textures.minecraft.net/texture/60558387b6658f5e9dcffc719214b603f603c4b04e708b7aabe75bcae91e804c"), // ML_Monster
        DyeColor.PURPLE to URL("http://textures.minecraft.net/texture/343cbdae1f20a79281d3a71adf242a35c8cc58562b415f1120bca9d94b76f254"), // ML_Monster
        DyeColor.BLUE to URL("http://textures.minecraft.net/texture/e39efc4b4eadec48576a5700ec812395510327e5d1e7c108fd8abc7796685aa3"), // ML_Monster
        DyeColor.BROWN to URL("http://textures.minecraft.net/texture/e5813715c2f34f05649f8fa3eaaa67f1eda5e6f9cf930fa9c2e0412d1f9728e1"), // ML_Monster
        DyeColor.GREEN to URL("http://textures.minecraft.net/texture/5753a8ec32be9c550d1c560acb941edd9e3b73ddbf1586923fb37b220b4553dd"), // ML_Monster
        DyeColor.RED to URL("http://textures.minecraft.net/texture/e0ce5b5ca9165ac77a9c3e3f64df0d3170d5afcf9d5a5575e3f0c0f21e43b83"), // ML_Monster
        DyeColor.BLACK to URL("http://textures.minecraft.net/texture/634ac5b398cf7c86e3f6f188a5127d8b283d772bf5885c70e0c130805f069950") // ML_Monster
    )

    private val specialFishHeadIndex = mapOf(
        SpecialFishType.ANEMONE to URL("http://textures.minecraft.net/texture/75cbde69c0bb3dfd8f710ee5f42c41e829a049a9df7099005ff745e32869c507"),
        SpecialFishType.BLACK_TANG to URL("http://textures.minecraft.net/texture/c69c5a025a58be61a5258664807ecc5d2fa8f0433e4ccfabe3c81abd28925baa"),
        SpecialFishType.BLUE_TANG to URL("http://textures.minecraft.net/texture/bcd25ad0dabec240d2ee792fe1426407d8fc9dd670aafe2d4e541c6226d9d813"),
        SpecialFishType.BUTTERFLYFISH to URL("http://textures.minecraft.net/texture/400a8fb316faac20bb966c596a3bcbfcfbd01f3c048fa02e3b3fb6a80709e8ec"),
        SpecialFishType.CICHLID to URL("http://textures.minecraft.net/texture/8b5274c9e487f67f9648510d1b3c5a70ee6060c9d71fdd1f19aa697427f290ec"),
        SpecialFishType.CLOWNFISH to URL("http://textures.minecraft.net/texture/36389acd7c8280d2c8085e6a6a91e182465347cc898db8c2d9bb148e0271c3e5"),
        SpecialFishType.COTTON_CANDY_BETTA to URL("http://textures.minecraft.net/texture/e3d7767de7acd9fe9e03832574b248344f0ae06f4c1a7c6cb5c4b0923aefe56d"),
        SpecialFishType.DOTTYBACK to URL("http://textures.minecraft.net/texture/d1c01eb1abaed3df80c203c34246f9713eea5fbbe65d12f4cb1ecc9018e954aa"),
        SpecialFishType.EMPEROR_RED_SNAPPER to URL("http://textures.minecraft.net/texture/bf2c006def4d873a58437128e779ffb49f46c693e85877ad7c78f5cabfd98548"),
        SpecialFishType.GOATFISH to URL("http://textures.minecraft.net/texture/9dc47b40ac31034a6ac028ce5e96d6ae270b739f742b35572a99947b9306bd7"),
        SpecialFishType.MOORISH_IDOL to URL("http://textures.minecraft.net/texture/7d39822c3c5b020acf68941af314b4579895a8cd76d0aa23003ef85130453d73"),
        SpecialFishType.ORNATE_BUTTERFLYFISH to URL("http://textures.minecraft.net/texture/adedaf827713d8aafb210cb65cb9bb1c562a98f1c337bec4e639ae5633c00cda"),
        SpecialFishType.PARROTFISH to URL("http://textures.minecraft.net/texture/fa16f5288b4dfc34486cc20b61ad20c4b4ac6b137bf9c831187997d002ef5ef6"),
        SpecialFishType.QUEEN_ANGELFISH to URL("http://textures.minecraft.net/texture/adfb4d7dff5456de70496414e874c6650a1e839563cc75d4b99380b216cfdbcd"),
        SpecialFishType.RED_CICHLID to URL("http://textures.minecraft.net/texture/38be3988d58ef595c57be9074f41122f47b2f67f379a39dc6f1ab9c45e2c4126"),
        SpecialFishType.RED_LIPPED_BLENNY to URL("http://textures.minecraft.net/texture/f2d22be12e14664cae3fe226d1b3487ee2a7d8e76a0e29bca4dbf9964b2a0f63"),
        SpecialFishType.RED_SNAPPER to URL("http://textures.minecraft.net/texture/2b8226ab9870b7c6c59d31b40b86edf7324eca674b70d55be8aae6a0b89e7d8b"),
        SpecialFishType.THREADFIN to URL("http://textures.minecraft.net/texture/127f6c673de31386e04b5da2ad8ebbdaac25ff2d9e9673dbe6329a06943abcf"),
        SpecialFishType.TOMATO_CLOWNFISH to URL("http://textures.minecraft.net/texture/7e92f0b0f79c7ba9dc81577be33a5c713fbe3972826b44bcf26feb6cc12b6434"),
        SpecialFishType.TRIGGERFISH to URL("http://textures.minecraft.net/texture/fc0d1e6d2a9df4f0ebbcd54778ff31b7c249e0d9944fced4b1a83afbaeeacfca"),
        SpecialFishType.YELLOWTAIL_PARROTFISH to URL("http://textures.minecraft.net/texture/5d7b92a1bdc733d2a53fb095c70b732b71a223a9ceca72b872e1ee990a6a907e"),
        SpecialFishType.YELLOW_TANG to URL("http://textures.minecraft.net/texture/4e0b0a93cc61eeebb2539b8adb2f49e292f2073c1d312a99c87b12da1be44336")
    )
    ...
    private val foxHeadIndex = mapOf(
        Fox.Type.RED to URL("http://textures.minecraft.net/texture/d8954a42e69e0881ae6d24d4281459c144a0d5a968aed35d6d3d73a3c65d26a"), // PandaClod
        Fox.Type.SNOW to URL("http://textures.minecraft.net/texture/41436377eb4c4b4e39fb0e1ed8899fb61ee1814a9169b8d08729ef01dc85d1ba") // PandaClod
    )

    private val llamaHeadIndex = mapOf(
        Llama.Color.BROWN to URL("http://textures.minecraft.net/texture/7f832466dcc7d5e7702cdee4cd555dbd39637d20adf9367fb03cfd6888baaae7"), // ML_Monster
        Llama.Color.CREAMY to URL("http://textures.minecraft.net/texture/bae25ddc2d2539c565dff2aa5006033f14cc06379fe28b0731c7bdc65ba0e016"), // ML_Monster
        Llama.Color.GRAY to URL("http://textures.minecraft.net/texture/6d2ffce9a174fe1c084e2d82052182d94f95ed436b75ff7ea7a4e94d94c72d8a"), // ML_Monster
        Llama.Color.WHITE to URL("http://textures.minecraft.net/texture/de703ab031ed66622f12957ef59a8b5c8a269cebd18f9326248b68c3bbe20163") // ML_Monster
    )

    private val pandaHeadIndex = mapOf(
        Panda.Gene.AGGRESSIVE to URL("http://textures.minecraft.net/texture/83fe1e782ae96a30336a03ef74681ce3a6905fcc673fa56c046aaee6aa28307d"), // PandaClod
        Panda.Gene.BROWN to URL("http://textures.minecraft.net/texture/c5d0d45bf992b072cf5c513e06beefe8bdc809c8150f3d14b883796a7b74e406"), // PandaClod
        Panda.Gene.LAZY to URL("http://textures.minecraft.net/texture/7818b681cace1c641919f53edadecb142330d089a826b56219138c33b7a5e0db"), // PandaClod
        Panda.Gene.NORMAL to URL("http://textures.minecraft.net/texture/dca096eea506301bea6d4b17ee1605625a6f5082c71f74a639cc940439f47166"), // PandaClod
        Panda.Gene.PLAYFUL to URL("http://textures.minecraft.net/texture/b6463e64ce29764db3cb46806cee606afc24bdf0ce14b6660c270a96c787426"), // PandaClod
        Panda.Gene.WEAK to URL("http://textures.minecraft.net/texture/5c2d25e956337d82791fa0e6617a40086f02d6ebfbfd5a6459889cf206fca787"), // PandaClod
        Panda.Gene.WORRIED to URL("http://textures.minecraft.net/texture/c8e921c57e54dd07337ffba629e72caf3850d836b76562b1bc3bc5949f2d41d") // PandaClod
    )

    private val traderLlamaHeadIndex = mapOf(
        Llama.Color.BROWN to URL("http://textures.minecraft.net/texture/5a4eed85697c78f462c4eb5653b05b76576c1178f704f3c5676f505d8f3983b4"), // ML_Monster
        Llama.Color.CREAMY to URL("http://textures.minecraft.net/texture/56307f42fc88ebc211e04ea2bb4d247b7428b711df9a4e0c6d1b921589e443a1"), // ML_Monster
        Llama.Color.GRAY to URL("http://textures.minecraft.net/texture/20fdfa60c624fb667c8313b2fb1dab40e0ad2e6e469b567bf596ad26392319c5"), // ML_Monster
        Llama.Color.WHITE to URL("http://textures.minecraft.net/texture/15ad6b69cc6b4769d3516a0ce98b99b2a5d406fea4912dec570ea4a4f2bcc0ff") // ML_Monster
    )
